            ...
            <div className='flex items-center sticky z-10 w-full top-0 bg-white p-2 pb-3 drop-shadow-md'>
                ...
                <div className='flex flex-1 justify-center items-center'>
                    <Link to="/search">
                        ...
                        <div className='border shadow-md cursor-pointer  border-gray-400 pl-2 rounded-3xl justify-center items-center' onClick={()=>setShowSearch(!showSearch)}>
                            <input className='text-sm p-1 h-7 cursor-pointer bg-white pl-2 focus:outline-none' type="text" disabled placeholder='click to explore'/>
